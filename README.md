...
5. **Migration CLI:** `openflow migrate <old_test.py>` rewrites an OpenTAP-Python test into a bare-metal pytest test using libcst. 20 transformer stages (11 V1a + 5 V1c + 1 V1d + 3 V1e).
